...
namespace AdminWebsite.Attributes
{
    public class HearingInputSanitizerAttribute : ActionFilterAttribute
    {
        public override void OnActionExecuting(ActionExecutingContext context)
        {
            ...
            {
                if (context.ActionArguments["request"] is BookNewHearingRequest newHearingRequest)
                {
                ...
                else if (context.ActionArguments["request"] is EditHearingRequest editHearingRequest)
                {

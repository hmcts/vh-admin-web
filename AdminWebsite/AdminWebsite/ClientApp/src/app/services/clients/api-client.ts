...
export class BHClient {
    ...
    protected processGetAllParticipantsChecklists(response: HttpResponseBase): Observable<ChecklistsResponse> {
        ...
        if (status === 200) {
            ...
            result200 = ChecklistsResponse.fromJS(resultData200);
     ...
     * @return Success
     */
    postPersonBySearchTerm(term: string | null | undefined): Observable<PersonResponse[]> {
     ...
     * @return Success
     */
    getSuitabilityAnswers(cursor: string | null | undefined, limit: number | null | undefined): Observable<SuitabilityAnswersResponse> {
...
export class HearingParticipantCheckListResponse implements IHearingParticipantCheckListResponse {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.completed_date = _data["completed_date"] ? new Date(_data["completed_date"].toString()) : <any>undefined;
            if (Array.isArray(_data["question_answer_responses"])) {
                this.question_answer_responses = [] as any;
                for (let item of _data["question_answer_responses"])
    ...
    toJSON(data?: any) {
        ...
        if (Array.isArray(this.question_answer_responses)) {
...
export class QuestionAnswerResponse implements IQuestionAnswerResponse {
    ...
    init(_data?: any) {
        if (_data) {
            this.question_key = _data["question_key"];
...
export class ParticipantRequest implements IParticipantRequest {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.solicitors_reference = _data["solicitors_reference"];
...
export class ParticipantResponse implements IParticipantResponse {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.telephone_number = _data["telephone_number"];
            this.username = _data["username"];
            this.solicitor_reference = _data["solicitor_reference"];

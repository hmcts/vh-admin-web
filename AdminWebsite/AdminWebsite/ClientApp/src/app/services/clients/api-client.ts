...
export class BHClient {
     ...
     * @return Success
     */
    updateUser(userName: string | null | undefined): Observable<void> {
...
export class HearingParticipantCheckListResponse implements IHearingParticipantCheckListResponse {
    ...
    init(data?: any) {
        if (data) {
            ...
            if (Array.isArray(data["question_answer_responses"])) {
...
export class CaseAndHearingRolesResponse implements ICaseAndHearingRolesResponse {
    ...
    init(data?: any) {
        if (data) {
            this.name = data["name"];
            if (Array.isArray(data["hearing_roles"])) {
...
export class SuitabilityAnswersResponse implements ISuitabilityAnswersResponse {
    ...
    init(data?: any) {
        if (data) {
            if (Array.isArray(data["participant_suitability_answer_response"])) {

...
export class BHClient {
     ...
     * @return Success
     */
    getBookingsList(cursor: string | null | undefined, limit: number | undefined, caseNumber: string | null | undefined, venueIds: number[] | null | undefined, caseTypes: string[] | null | undefined, startDate: Date | null | undefined, endDate: Date | null | undefined, lastName: string | null | undefined): Observable<BookingsResponse> {
        ...
        if (venueIds !== undefined && venueIds !== null)
            venueIds && venueIds.forEach(item => { url_ += "venueIds=" + encodeURIComponent("" + item) + "&"; });
        if (caseTypes !== undefined && caseTypes !== null)
            caseTypes && caseTypes.forEach(item => { url_ += "caseTypes=" + encodeURIComponent("" + item) + "&"; });

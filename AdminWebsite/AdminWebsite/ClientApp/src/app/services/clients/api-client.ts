...
export class BHClient {
    ...
    /**
     * @param cloudroomName (optional) 
     * @param hearingDate (optional) 
     * @param caseReference (optional) 
     * @return Success
     */
    getCvpAudioRecordingLink(cloudroomName: string | undefined, hearingDate: Date | undefined, caseReference: string | undefined): Observable<CvpAudioFileResponse[]> {
        let url_ = this.baseUrl + "/api/audio?";
        if (cloudroomName === null)
            throw new Error("The parameter 'cloudroomName' cannot be null.");
        else if (cloudroomName !== undefined)
            url_ += "cloudroomName=" + encodeURIComponent("" + cloudroomName) + "&";
        if (hearingDate === null)
            throw new Error("The parameter 'hearingDate' cannot be null.");
        else if (hearingDate !== undefined)
            url_ += "hearingDate=" + encodeURIComponent(hearingDate ? "" + hearingDate.toJSON() : "") + "&";
        if (caseReference === null)
            throw new Error("The parameter 'caseReference' cannot be null.");
        else if (caseReference !== undefined)
            url_ += "caseReference=" + encodeURIComponent("" + caseReference) + "&";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetCvpAudioRecordingLink(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetCvpAudioRecordingLink(<any>response_);
                } catch (e) {
                    return <Observable<CvpAudioFileResponse[]>><any>_observableThrow(e);
                }
            } else
                return <Observable<CvpAudioFileResponse[]>><any>_observableThrow(response_);
        }));
    }

    protected processGetCvpAudioRecordingLink(response: HttpResponseBase): Observable<CvpAudioFileResponse[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            if (Array.isArray(resultData200)) {
                ...
                for (let item of resultData200)
                    result200!.push(CvpAudioFileResponse.fromJS(item));
            }
            return _observableOf(result200);
            }));
        } else if (status === 400) {
        ...
        return _observableOf<CvpAudioFileResponse[]>(<any>null);
    }
     ...
     * @return Success
     */
    getBookingsList(cursor: string | undefined, limit: number | undefined): Observable<BookingsResponse> {
        let url_ = this.baseUrl + "/api/hearings?";
        if (cursor === null)
    ...
    protected processGetHearingsByCaseNumber(response: HttpResponseBase): Observable<HearingsForAudioFileSearchResponse[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    updateUser(body: string | undefined): Observable<void> {
...
export class HearingAudioRecordingResponse implements IHearingAudioRecordingResponse {
    audio_file_link?: string | undefined;
    ...
    init(_data?: any) {
        if (_data) {
            this.audio_file_link = _data["audio_file_link"];
        }
    }
    ...
    toJSON(data?: any) {
        data = typeof data === 'object' ? data : {};
        data["audio_file_link"] = this.audio_file_link;
        return data; 
    }
}
...
export class CvpAudioFileResponse implements ICvpAudioFileResponse {
    file_name?: string | undefined;
    sas_token_uri?: string | undefined;

    constructor(data?: ICvpAudioFileResponse) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): CvpAudioFileResponse {
        data = typeof data === 'object' ? data : {};
        let result = new CvpAudioFileResponse();
        result.init(data);
        return result;
    }
...
export interface ICvpAudioFileResponse {
    file_name?: string | undefined;
    sas_token_uri?: string | undefined;
}

...
export class BHClient {
     ...
     * @return Success
     */
    getCvpAudioRecordingLink(
        cloudroomName: string | undefined,
        hearingDate: Date | undefined,
        caseReference: string | undefined
    ): Observable<HearingAudioRecordingResponse> {
        let url_ = this.baseUrl + '/api/audio?';
        if (cloudroomName === null) throw new Error("The parameter 'cloudroomName' cannot be null.");
        else if (cloudroomName !== undefined) url_ += 'cloudroomName=' + encodeURIComponent('' + cloudroomName) + '&';
        if (hearingDate === null) throw new Error("The parameter 'hearingDate' cannot be null.");
        else if (hearingDate !== undefined) url_ += 'hearingDate=' + encodeURIComponent(hearingDate ? '' + hearingDate.toJSON() : '') + '&';
        if (caseReference === null) throw new Error("The parameter 'caseReference' cannot be null.");
        else if (caseReference !== undefined) url_ += 'caseReference=' + encodeURIComponent('' + caseReference) + '&';
        url_ = url_.replace(/[?&]$/, '');
    ...
    protected processGetCvpAudioRecordingLink(response: HttpResponseBase): Observable<HearingAudioRecordingResponse> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body : (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    getParticipantRoles(caseTypeName: string | undefined): Observable<CaseAndHearingRolesResponse[]> {
        ...
        if (caseTypeName === null) throw new Error("The parameter 'caseTypeName' cannot be null.");
        else if (caseTypeName !== undefined) url_ += 'caseTypeName=' + encodeURIComponent('' + caseTypeName) + '&';
        url_ = url_.replace(/[?&]$/, '');
...
export class CaseAndHearingRolesResponse implements ICaseAndHearingRolesResponse {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            if (Array.isArray(_data['hearing_roles'])) {
                ...
                for (let item of _data['hearing_roles']) this.hearing_roles!.push(item);
            }
        }
    }
    ...
    toJSON(data?: any) {
        ...
        if (Array.isArray(this.hearing_roles)) {
            data['hearing_roles'] = [];
            for (let item of this.hearing_roles) data['hearing_roles'].push(item);
        }
        return data;
    }
}

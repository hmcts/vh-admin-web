    ...
    getWorkAvailabilityHours(vho: string | null | undefined): Observable<VhoSearchResponse> {
        ...
        return _observableFrom(this.transformOptions(options_)).pipe(_observableMergeMap(transformedOptions_ => {
            ...
            if (response_ instanceof HttpResponseBase) {
                ...
                return <Observable<VhoSearchResponse>><any>_observableThrow(response_);
        }));
    }
...
export class VhoSearchResponse implements IVhoSearchResponse {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            if (Array.isArray(_data["vho_work_hours"])) {
                ...
                for (let item of _data["vho_work_hours"])
                    this.vho_work_hours!.push(VhoWorkHoursResponse.fromJS(item));
            }
        }
    }
    ...
    toJSON(data?: any) {
        ...
        if (Array.isArray(this.vho_work_hours)) {
            data["vho_work_hours"] = [];
            for (let item of this.vho_work_hours)
                data["vho_work_hours"].push(item.toJSON());
        }
        return data; 
    }
}

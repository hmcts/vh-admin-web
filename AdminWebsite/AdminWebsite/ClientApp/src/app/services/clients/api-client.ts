...
export class BHClient {
     ...
     * @return Success
     */
    getBookingsList(cursor: string | null | undefined, limit: number | undefined, caseNumber: string | null | undefined, venueIds: number[] | null | undefined, caseTypes: string[] | null | undefined, startDate: Date | null | undefined, endDate: Date | null | undefined): Observable<BookingsResponse> {

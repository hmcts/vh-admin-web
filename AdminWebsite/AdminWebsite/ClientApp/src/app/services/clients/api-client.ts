...
export class BHClient {
     ...
     * @return Success
     */
    getBookingsList(cursor: string | null | undefined, limit: number | undefined, caseNumber: string | null | undefined, venueIds: number[] | null | undefined): Observable<BookingsResponse> {

...
export class BHClient {
    ...
    /**
     * Edit a hearing
     * @param hearingId (optional) The id of the hearing to update
     * @param editHearingRequest (optional) Hearing Request object for edit operation
     * @return Success
     */
    editHearing(hearingId: string | null | undefined, editHearingRequest: EditHearingRequest | null | undefined): Observable<HearingDetailsResponse> {
        let url_ = this.baseUrl + "/api/hearings?";

...
namespace AdminWebsite.UnitTests.Helper
{
    public class DateListMapperTest
    {
        ...
        {
            var startDate = new DateTime(2020, 10, 1, 4, 30, 0, 0, DateTimeKind.Utc);
            var endDate = new DateTime(2020, 10, 6, 4, 35, 0, 0, DateTimeKind.Utc);
            var expectDays = 3;
        ...
        {
            var startDate = new DateTime(2020, 10, 1, 8, 0, 0, DateTimeKind.Utc);
            var endDate = new DateTime(2020, 10, 1, 8, 0, 0, DateTimeKind.Utc);
            var expectDays = 0;
        ...
        {
            var startDate = new DateTime(2023, 1, 2, 8, 0, 0, DateTimeKind.Utc);
            var endDate = new DateTime(2023, 1, 8, 8, 0, 0, DateTimeKind.Utc);
        ...
        {
            var startDate = new DateTime(2023, 1, 2, 8, 0, 0, DateTimeKind.Utc);
            var endDate = new DateTime(2023, 1, 2, 8, 0, 0, DateTimeKind.Utc);

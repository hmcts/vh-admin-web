...
namespace AdminWebsite.AcceptanceTests.Pages
{
    public class Summary : Common
    {
        ...
        private By _particpantRoundedBorder => By.XPath("//a[@class='vhlink']");
        ...
        public void EditParticipantRoundedBoarder(string uri) => SelectOption(_particpantRoundedBorder, uri);

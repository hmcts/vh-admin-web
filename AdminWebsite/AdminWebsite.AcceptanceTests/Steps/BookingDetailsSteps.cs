...
namespace AdminWebsite.AcceptanceTests.Steps
{
    ...
    public class BookingDetailsSteps : ISteps
    {
        ...
        private void VerifyTheBookingDetails()
        {
            ...
            _browsers[_c.CurrentUser.Key].Driver.WaitUntilVisible(BookingDetailsPage.CaseType).Text.Should().Be(_c.Test.HearingDetails.CaseType.Name);
            ...
            _browsers[_c.CurrentUser.Key].Driver.WaitUntilVisible(BookingDetailsPage.VideoAccessPoints).Text.Should().Be(_c.Test.VideoAccessPoints.DisplayName);
        }

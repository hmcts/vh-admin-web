...
dotnet sonarscanner begin /k:"${SONAR_PROJECT_KEY}" /o:"${SONAR_ORG}" /version:"${SONAR_PROJECT_VERSION}" /name:"${SONAR_PROJECT_NAME}" /d:sonar.host.url="${SONAR_HOST}" /d:sonar.login="${SONAR_TOKEN}" /d:sonar.cs.opencover.reportsPaths="${PWD}/Coverage/coverage.opencover.xml" /d:sonar.javascript.lcov.reportsPaths="${PWD}/AdminWebsite/AdminWebsite/ClientApp/coverage/lcov.info" /d:sonar.coverage.exclusions="**/AdminWebsite/Swagger/**/*, **/Program.cs, **/Startup.cs, **/Testing.Common/**/*, **/AdminWebsite.Common/**/*, **/AdminWebsite.IntegrationTests/**/*, **/AdminWebsite.UnitTests/**/*, **/AdminWebsite/Extensions/*, **/app-insights-logger.service.ts" /d:sonar.cpd.exclusions="**/Program.cs, **/Startup.cs, **/Testing.Common/**/*, **/AdminWebsite/Swagger/**/*" /d:sonar.exclusions="**/node_modules/**, **/*.spec.ts, *.spec.ts, **/ClientApp/src/*, **/ClientApp/coverage/**/*, **/Startup.cs, **/Program.cs, **/ConfigureServicesExtensions.cs, **/Swagger/*.cs"
